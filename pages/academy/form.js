...
// 세부 교육 과정 리스트 (PSAC)
const psacCourses = [
    '1주: 전력계통 해석의 기본 이론 (9.2 - 5)',
    '2주: 전력계통(설비) 보호기술 (9.8 - 11)',
    '3주: 동기발전기 전반적 기술 (9.24 - 27)',
    '4주: 보호릴레이 정정법과 보호협조 기술실무 (9.29 - 10.4)',
    '5주: 전력계통 서지해석과 전력설비 응용 (10.6 - 9)',
    '6주: HVDC, MVDC, LVDC 및 FACTS기술 (10.27 - 30)',
    '7주: 전력계통 동특성 II (10.22 - 24)',
    '8주: 전력계통 시뮬레이션 (10.29 - 31)',
    '9주: 디지털 변전기술 (11.3 - 6)',
    '10주: 탄소중립시대의 전력계통 계획과 운영기술 (11.11 - 14)',
    '11주: 전력산업의 디지털 트랜스포메이션 (11.17 - 20)',
    '12주: 에너지 시장과 에너지신산업 모델 (11.25 - 28)',
    '13주: 신재생에너지 최신발전기술과 계통연계 (12.2 - 5)'
];
